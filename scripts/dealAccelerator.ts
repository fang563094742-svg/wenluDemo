...
const DEFAULT_PAYMENT_CONFIG: PaymentConfig = {
  direct: {
    preferredLabel: "请由当前开发者补充可用支付方式",
    methods: [],
    remarkTemplate: "付款备注：{projectName}",
  },
  platform: {
    label: "可选公开入口",
    instruction: "如需公开承接页，请由当前开发者补充真实入口和流程。",
    link: "",
    note: "模板配置：避免继承上一位开发者的业务语境。",
  },
  binance: {
    owner: {
      label: "数字货币收款模板",
      accountType: "由当前开发者补充",
      holderName: "如需使用，请由当前开发者补充",
      evidence: "",
      policy: "模板配置：不要保留上一位开发者的账户归属信息。",
    },
    inbound: {
      label: "入金口径模板",
      steps: [],
      warning: "模板配置：请由当前开发者按实际收款方式补充。"
    },
    outbound: {
      label: "结算口径模板",
      steps: []
  ...
  confirmation: {
    defaultStartWindow: "请由当前开发者填写默认交付窗口。",
    askForProof: "请由当前开发者填写支付确认口径。",
  },
};
