 ...
 */
const CUE_RE =
  /问路|wenlu|你|您|妳|你们|你这|你的|你自己|这套(系统|东西|程序|服务|应用)?|这个(系统|平台|程序|应用|服务|工具|东西|ai)|该(系统|平台|服务|应用)|平台|你这边|你内部|你底层|系统(内部|架构|底层|是怎|怎么)|咱们这|\byou\b|\byour\b|\byourself\b/i;
